        ...
        return (
            <div className="chatPanel-feature">
                <form autoComplete="off" action="javascript:void(0);">
                    <input className={showSearchResult ? 'focus' : 'blur'} type="text" placeholder="Search..." ref={i => this.searchInput = i} onFocus={this.handleFocus} onKeyDown={this.handleInputKeyDown} />
                </form>
                    ...
                    <TabPane tab="All" key="all">
                        {
                            searchResult.users.length === 0 && searchResult.groups.length === 0 ?
                                <p className="none">Nothing found, Please try again.</p>
                                :
                                (
